    ...
    <aside class="sidebar">
        <div>
            ...
            <nav class="nav">
                ...
                <a href="{{ route('violations') }}" class="active">
    ...
    <main class="main">
        ...
        <section class="content">
            ...
            <div class="no-print"
                ...
                هذا التقرير يعتبر وثيقة رسمية وقانونية. يرجى التأكد من دقة البيانات المدخلة قبل الإرسال. سيتم تحويل
                الطالب تلقائياً إلى مجلس التأديب بناءً على هذا التقرير.
            </div>
                ...
                <div class="card violation-card" style="padding: 30px;">
                    ...
                    <div class="modal-actions"
                        ...
                        <button type="button" onclick="window.print()" class="btn"
                            style="background-color: #3b82f6; color: white; width: 150px; font-size: 15px; border: none; border-radius: 6px; cursor: pointer; transition: 0.3s; display: flex; align-items: center; justify-content: center; gap: 8px;">
